...
function SerializeDefine(...args) {
    return function serialize_define(target, propKey, descriptor) {
        ...
        if (!r1) {
            ...
            cerialize_1.serializeAs(r2, r1)(target, propKey, descriptor);
        }
    };
}
...
function DeserializeDefine(...args) {
    return function deserialize_define(target, propKey, descriptor) {
        const [r1, r2] = args;
        if (!r1) {
            cerialize_1.deserializeAs(propKey)(target, propKey, descriptor);
        }
        else if (typeof r1 !== "string") {
            cerialize_1.deserializeAs(r1, propKey)(target, propKey, descriptor);
        }
        else if (!r2) {
            cerialize_1.deserializeAs(r1)(target, propKey, descriptor);
        }
        else {
            cerialize_1.deserializeAs(r2, r1)(target, propKey, descriptor);
        }
    };
}
